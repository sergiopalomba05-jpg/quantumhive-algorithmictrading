...
**Configuración de VPS para producción:**

Tutorial completo paso a paso disponible en: `nucleo/gvca/vps_setup_guide.md`

**Resumen de configuración:**
- Oracle Cloud Free Tier: 4 OCPU, 24GB RAM, 200GB almacenamiento
- Ubuntu 22.04 LTS
- Python 3 + pip + dependencias (anthropic, flask, requests)
- Clon de repositorio GitHub privado (una vez creado por Sergio)
- Variables de entorno en `.env` (NUNCA hardcodear credenciales)
- Firewall: puertos 22 (SSH), 80 (HTTP), 443 (HTTPS), 5000-6000 (apps)
- Nginx para reverse proxy (opcional)
- Systemd para ejecución automática al reiniciar

**CEO Inteligencia Infinita en WhatsApp:**
- Agente implementado en `automatizacion/agentes/ceo_ii_whatsapp.py`
- Webhook Flask en puerto 5000
- Memoria SQLite persistente
- System prompt CEO II como socio estratégico senior
- Integración con Whisper para audio (transcripción)
- Guarda ideas en `vision_ceo.md` automáticamente
